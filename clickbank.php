...
$pid_is=$_GET["pid"];
$params = urldecode(trim($randomstring));
session_start();
list($randomstring,$ip,$price,$product_id,$referrer,$member) = explode('|',$params);

if(isset($_COOKIE['memcookie']) && $member='inside')
 	$signup_form = '<a href="/member/paid.php?pid='.$pid.'#top">Click Here To Access Your Product</a>';
else {
