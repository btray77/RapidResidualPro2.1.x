...
// AWS access info
if (!defined('awsAccessKey')) define('awsAccessKey', 'AKIAJAKF4XFRP72A2U4A');
if (!defined('awsSecretKey')) define('awsSecretKey', 'flaO4rQT7EVhjaIzO4R4sZhPHDGJphjEt3/ETmO2');
...
// List your buckets:
echo "<PRE>S3::listBuckets(): ".print_r($s3->listBuckets(), 1)."\n";

// Get the contents of our bucket
$bucket_contents = $s3->getBucket("rapidresidualpro");
