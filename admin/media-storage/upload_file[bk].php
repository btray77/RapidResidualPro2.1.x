...
<p><strong><?php echo 'Add Media ';?><?php echo ($bucket == 'local')? 'Local Uploads' : $bucket;?></p></strong>
...
<form id="upload_form" method="post" action="actions/content_action.php" enctype="multipart/form-data">
    <table width="100%" border="0">
     ...
     <tr id="form_div" style="display:table-row;">
     </tr>
          ...
          <table width="100%" border="0" align="center">
            <tr>
              ...
              <tr>
                <td>&nbsp;</td>
                <td>
                    Upload<input type="radio" name="sel_file" id="sel_file" checked="" value="upload" onchange="javascript:getUploadLink('upload');"/>
                    Link<input type="radio" name="sel_file" id="sel_file" value="link" onchange="javascript:getUploadLink('link');"/>
                </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
