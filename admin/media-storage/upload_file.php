          ...
          <table width="100%" border="0" align="center">
            <tr>
              ...
              <tr>
                <td>&nbsp;</td>
                <td>
                    Upload<input type="radio" name="sel_file" id="sel_file" checked="" value="upload" onclick="javascript:getUploadLink('upload');"/>
                    Link<input type="radio" name="sel_file" id="sel_file" value="link" onclick="javascript:getUploadLink('link');"/>
                </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
