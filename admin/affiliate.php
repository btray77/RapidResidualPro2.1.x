...
include ("session.php");
include ("header.php");
$GetFile = file("../html/admin/affiliate.html");
...
if (isset($_POST['submit']))
{
	...
	$agreement				= $db->quote($_POST["agreement"]);
	...
	$db->insert("update ".$prefix."affiliate set $set where id = '1'");
	$msg = "ed";
}

// Get Product info from database
$GetProd = $db->get_a_line("select * from ".$prefix."affiliate where id = '1'");
@extract($GetProd);
