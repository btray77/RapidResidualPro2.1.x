...
$Title = "Marketing Banners Management";
$targetpage = "market_banners.php"; 	//your file name  (the name of this file)
$tbl_name=$prefix."marketing_banners";		//your table name
...
{
	case 'add':
		$Message = '<div class="success"><img src="../images/tick.png" align="absmiddle"> Banner is Successfully Added</div>';
	break;
	case 'edit':
		$Message = '<div class="success"><img src="../images/tick.png" align="absmiddle"> Banner is Successfully Edited</div>';
	break;	
	case 'd':
		$Message = '<div class="success"><img src="../images/tick.png" align="absmiddle"> Banner is Successfully Deleted</div>';
	break;
	case 'ar':
		$Message = '<div class="success"><img src="../images/tick.png" align="absmiddle"> Banner is Successfully Unarchived!</div>';
	break;
	case 'un':
		$Message = '<div class="success"><img src="../images/tick.png" align="absmiddle"> Banner is Successfully Archived!</div>';
	break;
}
############# Operation ##################
...
function delete_content($id,$db,$prefix)
{
	...
	$db->insert("delete from ".$prefix."marketing_banners where id ='$id'");
...
function archive_content($id,$state,$db,$prefix)
{
	...
	$db->insert("update ".$prefix."marketing_banners set published='$state' where id ='$id'");
	if($state==1)
		return $msg='ar';
	else 
		return $msg='un';
	...
	<form name="limitForm" action="<?php echo  $targetpage?>#pagination" method="GET" style="float:left;">
	 ...
	 <td>
		 <?php if($obj_pri->canAdd($pageurl)){ ?>
		 	<div class="buttons">
		 		<a href="getbanner.php">Add Marketing Banner</a>
		 	</div>
		 <?php }?>
	 	<td>
	 </tr>
...
$i=0;
 ...
 if ($i%2 == 0){ $class= "standardRow";} else{ $class= "alternateRow";}
	...
	if($obj_pri->canDelete($pageurl))
		{
			...
			<img src="../images/cross-gray.png" alt="editImage" title="Click to delete this banner" Onclick="return confirm('."'".'Are you sure! you want to delete this page?'."'".')">
			</a>';
			}
			else
			{
			$delete='<a href="'.$targetpage.'?act=d&pageid='.$row['id'].'">
			<img src="../images/crose.png" alt="editImage" title="Click to delete this banner" Onclick="return confirm('."'".'Are you sure! you want to delete this page?'."'".')">
			</a>';
			}
		}
		else{
			...
			if($row['published']==0){		
				$delete='<a href="'.$targetpage.'?act=a&pageid='.$row['id'].'&state=1">
					<img src="../images/cross-gray.png" alt="editImage" title="Click to unarchive this banner">
			</a>';
				
			}
			else{
				$delete='<a href='.$targetpage.'?act=a&pageid='.$row['id'].'&state=0">
			<img src="../images/crose.png" alt="editImage" title="Click to archive this banner">
			</a>';}
  ...
  <tr class="<?php echo $class?>">
    ...
    <td valign="middle"><?php echo $row['banner_url']?></td>
    <td valign="middle"> 
    <div style="float:left;padding-left:16px;">
    	<a href="getbanner.php?bid=<?php echo $row['id']?>&act=e"> <img src="../images/editIcon.png" alt="editImage" title="Click to edit this banner" > </a>
    </div>
