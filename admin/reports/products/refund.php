...
$fieldNamesArray = array(
	...
	$query = "select count(*) as cnt from $tbl_name where product_id=$id and refunded=1";
	...
	$sql = "select 	o.id,o.member_id,o.date_added, CONCAT(m.firstname,' ',m.lastname) as name,m.email,m.username from $tbl_name o ," . $prefix."members m
		where o.refunded=1 and m.id=o.member_id and o.product_id=$id order by $field $dir  limit $start,$limit";
