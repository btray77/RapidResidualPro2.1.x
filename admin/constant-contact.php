...
$targetpage = "constant-contact.php";  //your file name  (the name of this file)
...
$query = "select count(*) as cnt from $tbl_name where rspname ='Constant-Contact'";
...
$sql = "select *  from $tbl_name where rspname ='Constant-Contact'  order by $field $dir  limit $start,$limit";
            ...
            <tr>
                ...
                <td>
                    <?php if ($obj_pri->canAdd($pageurl)) { ?>
                        ...
                        <div class="buttons">
                            <a href="addconstant-contact.php">Add <?php echo $Title ?></a>
                        </div>	
                        <div class="buttons">
                            <a href="settings-contact.php">Settings <?php echo $Title ?></a>
                        </div>
                    <?php } ?>
                </td>
            </tr>
                        ...
                        <tr class="<?php echo $class ?>">
                            ...
                            <td valign="middle">
                                <div style="float:left;padding-left:16px;">
                                    <a href="addconstant-contact.php?&id=<?php echo $row['id'] ?>">
