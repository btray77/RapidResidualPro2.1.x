...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var base = "/images"; /*Relative to Root*/
        ...
        function panelUpload() {
            $("#divUpload").html("<h3 style='margin-top:0px'>Upload Files</h3><input id='File1' type='file' /><br><small>jpg|jpeg|gif|png|txt|pdf|zip|mp3|mp4|flv are allowed</small>");
			$("#File1").uploadify({
                'swf': 'uploadify/uploadify.swf',
				'fileTypeExts' : '*.gif; *.jpg; *.png; *.txt; *.pdf; *.zip; *.mp3; *.mp4; *.flv',
...
<body style="margin:0px;background:#ffffff;font-size:12px">
    <form id="form1">
