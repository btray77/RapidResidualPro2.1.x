...
$Title = "Imnica Mail";
$targetpage = "imnica.php";  //your file name  (the name of this file)
...
$query = "select count(*) as cnt from $tbl_name where rspname ='imnica'";
...
$sql = "select *  from $tbl_name where rspname ='imnica' order by $field $dir  limit $start,$limit";
            ...
            <tr>
                ...
                <td>
                    <?php if ($obj_pri->canAdd($pageurl)) { ?>
                        ...
                        <div class="buttons">
                            <a href="addimnica.php">Add Imnica</a>
                        </div>	
                    <?php } ?>
                </td>
            </tr>
	...
	Responder Name</a><span class="<?php echo getCssClass('field2', $dir, $fieldName); ?>">&nbsp;</span>
			...
			<img src="../images/crose.png" alt="editImage" title="Click to archive ">
                        ...
                        <tr class="<?php echo $class ?>">
                            ...
                            <td valign="middle" style="text-align:left;width: 36em"><?php echo $row["rspname2"] ?></td>
                            <td valign="middle" style="text-align:center;width: 36em"><?php echo $row["trackingtag1"] ?></td>
                            <td valign="middle" style="text-align:left;width: 36em"><?php echo $row["arp_list_id"] ?></td>
                            <td valign="middle">
                                <div style="float:left;padding-left:16px;">
                                    <a href="addimnica.php?&id=<?php echo $row['id'] ?>">
