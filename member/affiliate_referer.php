...
$fieldNamesArray = array(
	...
	$query = "select count(id) as cnt from $tbl_name where ref = '$mid'";
    ...
    DATEDIFF( NOW( ) , FROM_UNIXTIME( last_login ) ) AS DAYS
    from  $tbl_name where  ref = '$mid' order by $field $dir  limit $start,$limit";
...
echo "<tr><td colspan='6' style='text-align:center'>Sorry no record forund</td></tr>";
 ?>
</table>
<div class="pages">
