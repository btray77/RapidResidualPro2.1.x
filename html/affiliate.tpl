...
{$index_page}
{$message}
<form name="login" id="login" action="affiliate.php" method="post" enctype="multipart/form-data" onsubmit="return formCheck(login);">
